...
from aiolifx.models.product import Product
...
features_map: dict[int, dict[str, Any]] = {
    ...
    70: {"buttons": True, "chain": False, "color": False, "extended_multizone": False, "hev": False, "infrared": False, "matrix": False, "multizone": False, "relays": True, "temperature_range": None},
    71: {"buttons": True, "chain": False, "color": False, "extended_multizone": False, "hev": False, "infrared": False, "matrix": False, "multizone": False, "relays": True, "temperature_range": None},
    81: {
        "buttons": False,
        "chain": False,
        "color": False,
    ...
    89: {"buttons": True, "chain": False, "color": False, "extended_multizone": False, "hev": False, "infrared": False, "matrix": False, "multizone": False, "relays": True, "temperature_range": None},
    90: {
        "buttons": False,
        "chain": False,
        "color": True,
...
def create_product_dict() -> dict[int, Product]:
    products_dict = {}
    for product_id, product_name in product_map.items():
        features = features_map[product_id].copy()
        features["id"] = product_id
        features["name"] = product_name
        products_dict[product_id] = Product.model_validate(features)
    return products_dict


products_dict = create_product_dict()
